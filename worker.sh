...
curl -sfL https://get.k3s.io | K3S_URL="https://${MANAGER_IP}:6443" K3S_TOKEN="${NODE_TOKEN}" INSTALL_K3S_EXEC="--no-flannel --node-ip=${WORKER_IP} --node-external-ip=${WORKER_IP}" sh -
